...
/**
 * This is the root element of the statistics on Status messages.
 * 
...
public class DAC2StatisticsSTS {

    @XmlElement(name = "Header", required = true)
    protected Header header;
    @XmlElement(required = true)
    protected List<RecordsTypeDAC2STS> records;
     ...
     * {@link RecordsTypeDAC2STS }
     * 
     * 
     */
    public List<RecordsTypeDAC2STS> getRecords() {
        if (records == null) {
            records = new ArrayList<RecordsTypeDAC2STS>();
        }
        return this.records;
    }
