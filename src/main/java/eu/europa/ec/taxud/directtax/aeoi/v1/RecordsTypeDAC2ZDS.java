...
public class RecordsTypeDAC2ZDS {

    @XmlElement(name = "ZDS-110")
    protected List<ZDS110DAC2TypeZDS> zds110;
     ...
     * {@link ZDS110DAC2TypeZDS }
     * 
     * 
     */
    public List<ZDS110DAC2TypeZDS> getZDS110() {
        if (zds110 == null) {
            zds110 = new ArrayList<ZDS110DAC2TypeZDS>();
        }
        return this.zds110;
    }
