...
public class DAC1StatisticsLIPS {

    @XmlElement(name = "Header", required = true)
    protected Header header;
    @XmlElement(required = true)
    protected List<RecordsTypeLIPS> records;
     ...
     * {@link RecordsTypeLIPS }
     * 
     * 
     */
    public List<RecordsTypeLIPS> getRecords() {
        if (records == null) {
            records = new ArrayList<RecordsTypeLIPS>();
        }
        return this.records;
    }
