...
/**
 * <p>Classe Java per MsgApplicationIdSTS_Type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * <p>
 * <pre>
 * &lt;simpleType name="MsgApplicationIdSTS_Type"&gt;
 ...
 * 
 */
@XmlType(name = "MsgApplicationIdSTS_Type")
@XmlEnum
public enum MsgApplicationIdSTSType {
    ...
    MsgApplicationIdSTSType(String v) {
        value = v;
    }
    ...
    public static MsgApplicationIdSTSType fromValue(String v) {
        for (MsgApplicationIdSTSType c: MsgApplicationIdSTSType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
