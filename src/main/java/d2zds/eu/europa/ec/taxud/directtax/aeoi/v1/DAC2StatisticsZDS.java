...
/**
 * This is the root element of the statistics on Zero Data messages.
 * 
 * <p>Classe Java per DAC2_Statistics element declaration.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;element name="DAC2_Statistics"&gt;
 *   &lt;complexType&gt;
 *     &lt;complexContent&gt;
...
@XmlRootElement(name = "DAC2_Statistics")
public class DAC2StatisticsZDS {

    @XmlElement(name = "Header", required = true)
    protected Header header;
    @XmlElement(required = true)
    protected List<RecordsTypeDAC2ZDS> records;
     ...
     * {@link RecordsTypeDAC2ZDS }
     * 
     * 
     */
    public List<RecordsTypeDAC2ZDS> getRecords() {
        if (records == null) {
            records = new ArrayList<RecordsTypeDAC2ZDS>();
        }
        return this.records;
    }
